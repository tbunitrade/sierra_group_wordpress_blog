...
add_action('get_footer', 'sierra_group_register_all_scripts_and_styles');

// ===================================================
// ==== Load All Scripts & Styles  ===================
// ===================================================

function sierra_group_load_all_scripts_and_styles() {
...
add_action( 'wp_enqueue_scripts', 'sierra_group_load_all_scripts_and_styles' );

// =====================================================
// ==== Load Admin Scripts & Styles  ===================
// =====================================================

// wp_localize_script( 'sierra-group-script', 'ajax_posts', array(
//     'ajaxurl' => admin_url( 'admin-ajax.php' ),
//     'noposts' => __('No older posts found', 'sierra-group'),
// ));
